...
from app.modules.user.crud.user import (
    get_user, get_user_by_email, get_user_by_username, get_users, get_users_count,
    create_user as crud_create_user,
    update_user as crud_update_user, delete_user as crud_delete_user, verify_password
)
...
async def update_users_me(user_in: UserUpdate, current_user: User = Depends(get_current_active_user), db: Session = Depends(get_db)):
    try:
